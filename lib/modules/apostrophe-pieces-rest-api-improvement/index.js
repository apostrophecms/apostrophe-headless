...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.addRestApiRoutes = function() {
      ...
      var bearerMiddleware = restApi.bearerMiddleware;
      ...
      // GET many
      self.apos.app.get(endpoint, bearerMiddleware, function(req, res) {
      ...
      // GET one
      self.apos.app.get(endpoint + '/:id', bearerMiddleware, function(req, res) {
      ...
      // POST one
      self.apos.app.post(endpoint, bearerMiddleware, function(req, res) {
      ...
      // UPDATE one
      self.apos.app.put(endpoint + '/:id', bearerMiddleware, function(req, res) {
        var id = self.apos.launder.id(req.params.id);
      ...
      // DELETE one
      self.apos.app.delete(endpoint + '/:id', bearerMiddleware, function(req, res) {
        var id = self.apos.launder.id(req.params.id);
        return async.series({
