...
module.exports = {
  ...
  construct: function(self, options) {
    ...
    self.addRestApiRoutes = function() {
      ...
      if (options.restApi === true) {
        options.restApi = {};
      }
      options.restApi.tree = _.merge({ 
        depth: 1000, 
        published: null, 
        trash: false, 
        orphan: null, 
        ...
        areas: false, 
        permission: false
      }, options.restApi.tree || {});

      options.restApi.children = (options.restApi.children !== undefined) ? options.restApi.children : true;
      options.restApi.ancestors = (options.restApi.ancestors !== undefined) ? options.restApi.ancestors : true;
      ...
      self.apos.app.get(endpoint, function(req, res) {
        ...
        if (all) {
          ...
          return self.findForRestApi(req).and({ level: 0 }).children(options.restApi.tree).toObject(function(err, page) {
            if (err) {
              console.error(err);
    ...
    self.findForRestApi = function(req) {
      var cursor =  self.find(req).ancestors(options.restApi.ancestors).children(options.restApi.children).published(null);
